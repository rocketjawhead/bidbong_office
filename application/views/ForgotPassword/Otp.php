              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Masukkan Kode OTP</h1>
                    <?php
                  ...
                  <form action="<?php echo site_url('ForgotPassword/check_otp/');?><?php echo $this->uri->segment(3);?>" method="post" role="form" class="user">
                    <div class="form-group">
                      <input type="otp" class="form-control form-control-user" placeholder="Kode OTP" name="otp">
                    </div>
