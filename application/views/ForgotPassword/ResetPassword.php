            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form action="<?php echo site_url('ForgotPassword/request_reset_password/');?><?php echo $this->uri->segment(3);?>" method="post" role="form" class="user">
                    <div class="form-group">
                      <input type="password" class="form-control form-control-user" placeholder="Kata Sandi" name="password">
                    </div>
                    <div class="form-group">
                      <input type="password" class="form-control form-control-user" placeholder="Korfirmasi Kata Sandi" name="password_conf">
                    </div>
