            ...
            <div class="col-lg-12">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Update User (Cashier)</h6>
                </div>
                <form action="<?php echo site_url('User/update/');?><?php echo $this->uri->segment(3);?>" method="post" role="form">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <select class="form-control" name="branch_id" required>
                      <option value="<?php echo $branch_id;?>">Data Terpilih : <?php echo $branch_name;?></option>
                      <?php 
