          ...
          <div class="row">
            ...
            <div class="col-lg-12">
              ...
              <div class="card shadow mb-4">
                ...
                <form action="<?php echo site_url('Room/insert');?>" method="post" role="form" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="maxxBidder">
                  </div>

                  <div class="form-group">
                    <label>Start Bid</label>
                    <input type="date" class="form-control" name="startBid">
                  </div>

                  <div class="form-group">
                    <label>End Bid</label>
                    <input type="date" class="form-control" name="endBid">
                  </div>

                  <div class="form-group">
                    <label>Winner Date</label>
                    <input type="date" class="form-control" name="setWinnerDate">
                  </div>
